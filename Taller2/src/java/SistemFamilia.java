...
public class SistemFamilia extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Familia tmp = new Familia("Familia 1");
        ArrayList<Familia> list = new ArrayList<Familia>();
        list.add(tmp);
        request.setAttribute("familias", list);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String clave = request.getAttribute("clave").toString();
        String familia = request.getAttribute("familia").toString();
