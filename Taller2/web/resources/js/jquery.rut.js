...
(function($){
	...
	$.fn.rut = function(options){
		...
		var defaults = {parent:".form-group"};
			...
			$(this).focusout(function(){
                                if(this.value != ""){
                                    ...
                                    if(valida(this.value)){
                                            $(this).closest(selected.parent).removeClass("has-error").addClass("has-success");
                                    }else{
                                            $(this).closest(selected.parent).removeClass("has-success").addClass("has-error");
                                    }
                                }
			})
		})
